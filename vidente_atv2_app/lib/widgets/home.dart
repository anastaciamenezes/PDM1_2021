...
import 'package:vidente_atv2_app/models/previsao_hora.dart';
import 'package:vidente_atv2_app/services/previsao_service.dart';
import 'package:vidente_atv2_app/widgets/proximas_temperaturas.dart';
import 'package:vidente_atv2_app/widgets/resumo.dart';
          ...
          child: FutureBuilder<List<PrevisaoHora>>(
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                  children: [
                    Resumo(
                      cidade: BuscaCidadeController.instance.nameCidade,
